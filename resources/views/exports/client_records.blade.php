<table>
    ...
    @foreach ($clients as $client)
        <tr>
            <td>{{$client->id ?? ''}}}</td>
            <td>{{date('d-M',strtotime($client->qa_visit_date))}}</td>
            ...
            <td>{{$client->cg_key_info_save ?? ''}}</td>
            <td>{{$client->bath_hoist ?? ''}}</td>
            <td>{{$client->bt_hoist_service_date ?? ""}}</td>
            <td>{{$client->starlift ?? ""}}</td>
            <td>{{$client->startlift_service_date ?? ""}}</td>
            <td>{{$client->hoist ?? ""}}</td>
            <td>{{$client->hoist_service_date ?? ""}}</td>
