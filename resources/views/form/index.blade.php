                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group ">
                                    <input name="client_dob" readonly value="{{\Carbon\Carbon::parse($client->dob)->format('d-M-y')}}" type="text" class="form-control ">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group date" data-provide="datepicker">
                                    <input name="qa_visit_date" value="{{\Carbon\Carbon::today()->format('d-M-y')}}" type="text" class="form-control required-field border-clr">
                                    <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    <input name="care_start_date" readonly value="{{\Carbon\Carbon::parse($client->care_start_date)->format('d-M-y')}}" type="text" class="form-control">
                                    <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span></div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div id="card-2" class="bg-white collapse" aria-labelledby="property-sold" data-parent="#formValues">
                        <div class="row mt-2 outer-wrap" id="cart-item-1">
                            ...
                            <div class="col-lg-6 care_giver_name">
                                ...
                                <input type="text" name="care_giver_name[]" value="" readonly class="fl-3 required-field " />
                            </div>
                            <div class="col-lg-6">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="text" name="Average_giver_total" value="" value="" class="fl-3 total_average total_average2" readonly />
                        </div>
                    ...
                    <div class="card shadow-box incomplete">
                        ...
                        <div id="card-3" class="collapse bg-white  " aria-labelledby="land-sold" data-parent="#formValues">
                            <div class="row mt-2">
                                <div class="col-lg-6">
                                    <label><span class="care-text">CAREManager</span> </label>
                                    <input type="text" name="care_manager" value="" readonly />
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" class="average total_average2" value="" name="Cm_average" readonly />
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="average total_average2 " value="" name="Off_average" readonly />
                                </div>
                                <div class="col-lg-12">
                                    <label>Comment</label>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="CSAT" class="CSAT" value="" readonly />
                                </div>
                                <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between col-lg-12">
                        ...
                        <div class="card shadow-box incomplete">
                            ...
                            <div id="card-4" class="collapse bg-white  " aria-labelledby="land-info" data-parent="#formValues">
                                <div class="row mt-2">
                                    ...
                                    <div class="col-lg-6">
                                        <label>Name</label>
                                        <input type="text" name="adv_name" value="" class="required-field" />
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="adv_disc" placeholder="Please Discuss" value="" class="required-field" />
                                    </div>
                                    <div class="col-lg-12">
                            ...
                            <div class="card shadow-box incomplete">
                                ...
                                <div id="card-5" class="collapse bg-white  " aria-labelledby="" data-parent="#formValues">
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-lg-12">
                                            <label>Details</label>
                                            <input type="text" name="Cp_details" value="" class="required-field" />
                                        </div>
                                        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between col-lg-12">
                                    ...
                                    <div id="card-6" class="collapse bg-white  " aria-labelledby="six" data-parent="#formValues">
                                        <div class="row mt-2">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" value="" name="review_care_needs" />
                                            </div>
                                            <div class="col-lg-12">
                                                <label>Review Care Plan</label>
                                                <input type="text" value="" name="review_care_plan" />
                                            </div>
                                            <div class="col-lg-12">
                                                <label>Expand on Unmet Needs</label>
                                                <input type="text" value="" name="expand_on_unmet_needs" />
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" value="" name="agree_update_next_schedule" />
                                            </div>
                                            <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between col-lg-12">
                                        ...
                                        <div id="card-7" class="collapse bg-white  " aria-labelledby="land-info" data-parent="#formValues">
                                            <div class="row mt-2">
                                                ...
                                                <div class="col-lg-6 medi-set hidden">
                                                    ...
                                                    <input type="text" value="" name="Medi_set_type" class="fl-3 " />
                                                </div>
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6 ">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 hide-on-no hidden">
                                                            ...
                                                            <div class="input-group date" data-provide="datepicker">
                                                                <input name="bt_hoist_service_date" value="" type="text" class="form-control ">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 hide-on-no hidden">
                                                            <label>Service Date</label>
                                                            <div class="input-group date" data-provide="datepicker">
                                                                <input name="starlift_service_date" value="" type="text" class="form-control ">
                                                                <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 hide-on-no hidden">
                                                            <label>Service Date</label>
                                                            <div class="input-group date" data-provide="datepicker">
                                                                <input name="hoist_service_date" value="" type="text" class="form-control ">
                                                                <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 d-none profile_service_date">
                                                            <label>Service Date</label>
                                                            <div class="input-group date" data-provide="datepicker">
                                                                <input name="profile_service_date" value="" type="text" class="form-control ">
                                                                <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 d-none wheelchair_service_date">
                                                            <label>Service Date</label>
                                                            <div class="input-group date" data-provide="datepicker">
                                                                <input name="wheelchair_service_date" value="" type="text" class="form-control ">
                                                                <div class="input-group-addon"> <span class="glyphicon glyphicon-th"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <label>Other</label>
                                                    <input type="text" value="" name="Sr_other"></input>
                                                </div>
                                                <div class="col-lg-12">
                                                    <label>Follow Up Actions</label>
                                                    <input type="text" name="Sr_follow_up" value=""></input>
                                                </div>
                                                <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between col-lg-12">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="Hygine_detail" type="text" value="" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="Cj_detail" type="text" value="" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="Pref_sheet_detail" value="" type="text" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="refill_detail" type="text" value="" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="guidline_detail" value="" type="text" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="time_in_detail" value="" type="text" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 show-on-no hidden">
                                                                ...
                                                                <input name="Cg_content_log_detail" value="" type="text" placeholder="Enter Details" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 show-on-no hidden">
                                                                    <label>Details</label>
                                                                    <input name="Compatible_detail" value="" type="text" placeholder="Enter Details" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 show-on-no hidden">
                                                                    <label>Details</label>
                                                                    <input name="dependable_detail" value="" type="text" placeholder="Enter Details" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 show-on-no hidden">
                                                                    <label>Details</label>
                                                                    <input name="capable_detail" value="" type="text" placeholder="Enter Details" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <label>Recommendable for more Hrs</label>
                                                            <input name="recomm" value="" type="text" />
                                                        </div>
                                                        <div class="d-flex flex-column flex-sm-row align-items-center justify-content-sm-between col-lg-12">
                                                ...
                                                <div class="card shadow-box incomplete">
                                                    ...
                                                    <div id="card-10" class="collapse bg-white  " aria-labelledby="" data-parent="#formValues">
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <label>Other</label>
                                                                <input type="text" value="" name="train_other">
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label>Notes</label>
                                                                <input name="train_note" value="" type="text">
                                                            </div>
...
<script>
    ...
    function onSuccessSubmit(status, record_id) {
        if (status == '1') {
            $('#submit').removeAttr('disabled');
            $('#save_draft').removeAttr('disabled');
            toastr('Form Saved As Draft', 'success');
        }
        if (status == '2') {
            $('#save_draft').hide();
            $('#submit').hide();
...
<script>
    $(document).ready(function() {
        ...
        if (clientRecord) {
            ...
            /*Swal.fire({
                title: 'Confirmation',
                text: "Do You Want to Load Record ?",
                type: 'info',
