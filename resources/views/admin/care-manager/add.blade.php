...
@section('nav-title', 'CAREManager Add')
@section('content')

    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form class="validate-form" action="{{ route('admin.caremanager.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card ">
                        <div class="card-header card-header-primary card-header-icon">
                            ...
                            <h5 class="card-title">Add CAREManager</h5>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="comment" placeholder="Comment" required id="comment" class="form-control @error('comment') is-invalid @enderror" value="{{ old('comment') }}" autocomplete="off">
                                                @error('comment')
                                                <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
