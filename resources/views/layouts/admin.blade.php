...
<head>
    ...
    <title>@yield('title') - QA System</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('admin_theme') }}/assets/css/custom.css">
    <style>
        .h1,
        .h2,
        .h3,
...
<body class="">
    <div class="wrapper ">
        ...
        <div class="main-panel">
            ...
            @elseif(auth()->user()->role=='care_manager')
            @include('care-manager.components.sidebar')
            <div class="main-panel">
                <!-- Navbar -->
                @include('care-manager.components.navbar')
                @endif
                <!-- End Navbar -->
                <div class="content">
                    <div class="content">
